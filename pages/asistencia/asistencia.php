...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1> <i class='fa fa-edit'></i> <big><u>Asistencia</u></big></h1>
        <ol class="breadcrumb">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-success">
                    <form action="asistencia2.php" method="get">   
                            ...
                            <div class="col-md-12">
                                <div class="panel panel-default">
                                    ...
                                    <div class="panel-heading">
                                        <div class="page-heading"><i class="glyphicon glyphicon-edit"></i> Asistencia </div>
                                    </div> <!-- /panel-heading -->

                                    <div class="panel-body">
                                        <h4> <b>Seleccionar los parametros de Asistencia :</b> </h4> <br>
                                        <h5> Por favor ingrese el GRADO el cual desea marcar su asistencia: </h5>
                                        ...
                                        <div  class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <select class="form-control select2" id="accion" name="accion" style="width: 100%;" required>
                                                    <option value="">Seleccione</option>
                                                    <option value="ver">Ver Asistencias</option>
                                                    <option value="ingresar">Ingresar Asistencias</option>
                                                </select>
                                            </div>
                                        </div>
