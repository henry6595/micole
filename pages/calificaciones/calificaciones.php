...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1> <i class='fa fa-edit'></i> <big><u>Calificaciones</u></big></h1>
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="#"><i class="fa fa-home"></i>Inicio</a></li>
            <li class="breadcrumb-item"><a href="#">Calificaciones</a></li>
            <li class="active">Calificar alumnos</li>
        </ol> 
    </section>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-success">
                    <form action="calificaciones2.php" method="get">   
                        <div class="row">
                            <div class="col-md-12">
                                            ...
                                            <div class="col-sm-6">
                                                <select class="form-control select2" id="grado" name="grado" style="width: 100%;" required>
                                                    ...
                                                    if ($_SESSION['user_rol'] == 4) {
                                                        $sql = "select distinct g.id,g.descripcion from horario h join grado g on g.id = h.grado where h.docente = " . $_SESSION['user_dni'];
                                                    } else {
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <center>
                                    <input type="submit" value="Siguiente" class="btn btn-success"><br><br>
                                </center>
                            </div><!-- /.col -->
