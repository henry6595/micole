...
function enviar_correos_administrativos($usuario_destinatario, $password,$rol,$correo) {
...
//Assunto da mensagem
$Mailer->Subject = 'Bienvenido a MiCole';
...
$message = '<div style="border-radius:15px;  padding: 20px; width:400px;background:#ffffff;border:2px dotted blue;text-align:left" >'
        ...
        . 'Estimado Usuario '.$usuario_destinatario.': <br>'
        . 'Recibe una cordial bienvenida a <strong>MiCole!</strong> <br><br>'
        . 'Se le env&iacute;a sus datos de acceso : <br>'
        . 'Contrase&ntilde;a:'.$password.' <br>'
        . 'Rol&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: '.$rol.' <br>'
        . 'Fecha de creaci&oacute;n : '.$date.'<br>'
        . '</font>'
        . '</p>'
        . '</div>'
...
$Mailer->AltBody = 'Bienvenido a MiCole!';
