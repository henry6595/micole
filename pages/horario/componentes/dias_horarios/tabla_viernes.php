...
<div class="row">
    <div class="col-sm-12 table-responsive">
        ...
        <table  style="width: 100%;text-align:center;" class="table  table-hover table-condensed table-bordered">
            ...
            <?php
            $sql = "SELECT h.indice,h.turno,h.curso,CONCAT(l.apellidos,' ,',l.nombres),g.descripcion,h.seccion,h.dia from horario h join grado g on g.id=h.grado left join login l on l.dni = h.docente where dia ='Viernes' and grado ='" . $_SESSION['horario_grado'] . "' ";
