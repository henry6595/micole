...
include '../correo/email_nuevo_administrativo.php';
?>
<?php
    ...
    if ($password != $temp) {
        ...
        if ($rpta == 0) {
            ...
            if ($rows >= 1) {
                ...
                $sql = "call registrar('$password','$nombre','$apellido','$email','$rol','$dni','$datepicker','$celular','$telefono','$direccion')";
                //echo  $sql;

                if (DBi::$mysqli->query($sql) === TRUE) {
                   
                    $correoenviado = enviar_correos_administrativos($nombre.' '.$apellido, $password,$rol_name,$email);
...
<div class="content-wrapper">
    <section class="content-header">
        <h1> <i class='fa fa-edit'></i> <big><u>Registro de Administrativos</u></big></h1>
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="#"><i class="fa fa-home"></i>Inicio</a></li>
            <li class="breadcrumb-item"><a href="#">Usuarios</a></li>
            <li class="active">Registrar administrativos</li>
        </ol>
    </section>
