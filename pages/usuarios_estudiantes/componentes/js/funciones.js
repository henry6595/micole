...
$(document).ready(function () {
    ...
    manageProductTable = $('#manageProductTable').DataTable({
        dom: 'Blrtip',
        'ajax': 'componentes/php/consultar_estudiantes.php',
        "buttons": [
            {extend: 'excel',
                exportOptions: {
...
function editUser(userId = null) {
    if (userId) {
        ...
        $.ajax({
            url: 'componentes/php/seleccionar_estudiantes.php',
            type: 'post',
            data: {userId: userId},
            dataType: 'json',
            success: function (response) {
                ...
                $("#editApellido").val(response.apellidos);
                 $("#editSeccion").val(response.seccion); 
                $("#editGrado").val(response.grado); 
...
function removeUser(userId = null) {
    if (userId) {
        ...
        $("#removeUserBtn").unbind('click').bind('click', function () {
            ...
            $.ajax({
                url: 'componentes/php/bloquear_estudiantes.php',
                type: 'post',
                data: {userId: userId},
                dataType: 'json',
                success: function (response) {
...
function inremoveUser(userId = null) {
    if (userId) {
        ...
        $("#inremoveUserBtn").unbind('click').bind('click', function () {
            ...
            $.ajax({
                url: 'componentes/php/desbloquear_estudiantes.php',
                type: 'post',
                data: {userId: userId},
                dataType: 'json',
                success: function (response) {
