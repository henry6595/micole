...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1> <i class='fa fa-edit'></i> <big><u>Mi horario</u></big></h1>
        <ol class="breadcrumb">
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            ...
                            <select id="selectCurso" onchange="myPillFilter(0, 'selectCurso')" class="form-control select2" style="width: 100%;">                      
                                ...
                                <?php
                                $sql = "select DISTINCT h.curso from horario h  where h.grado =" . $_SESSION['grado_id'] . "  order by h.curso";
                        ...
                        <div class="col-md-3">
                            <label><font color="black">Día :</font></label>
                            <select id="selecttipo" onchange="myPillFilter2(2, 'selecttipo')" class="form-control select2" style="width: 100%;">                      
                                <option value="">Seleccionar</option>
                                <?php
                                $sql = "select d.descripcion from dia d order by id";
